...
class IntroSliderAdapter : RecyclerView.Adapter<IntroSliderAdapter.IntroViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): IntroViewHolder {
       return IntroViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.intro_slider_ticket,parent,false))
    }
    ...
    override fun onBindViewHolder(holder: IntroViewHolder, position: Int) {
        ...
        if(position == 1){
            ...
            holder.tv_intro_des.text = "Get Notification to get Hydrated, Water is Your Best Friend for Life"
        ...
        if(position == 2){
            ...
            holder.tv_intro_des.text = "Your goal is not to battle with the mind, but to witness the mind"
